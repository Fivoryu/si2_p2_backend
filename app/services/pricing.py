...
def calculate_service_offer(
    ...
    prioridad_cost = base * 0.25 if prioridad == "ALTA" else 0.0
    quality_cost = base * max(rating - 3.0, 0.0) * 0.06
    precio = (base * factor) + distancia_cost + prioridad_cost + quality_cost
